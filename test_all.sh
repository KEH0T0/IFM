...
CUDA_VISIBLE_DEVICES=$GPU_ID python -m scripts.animate --exp_config configs/prompts/2-DynaVision.yaml --H 1024 --W 1024 --L 16 --xformers \
...
CUDA_VISIBLE_DEVICES=$GPU_ID python -m scripts.animate --exp_config configs/prompts/4-DeepBlue.yaml --H 1024 --W 1024 --L 16 --xformers \
--instantid True --face_dir /home/nas4_user/taewoongkang/repos/2d/AnimateDiff/examples/images.jpeg 
